...
lxc-attach -n $5 sudo apt-get -- -y install autoconf autoconf-archive automake
lxc-attach -n $5 sudo apt-get -- -y install autotools-dev libtool-bin pkg-config
lxc-attach -n $5 sudo apt-get -- -y install doxygen graphviz
lxc-attach -n $5 sudo apt-get -- -y install txt2man txt2manwrap
lxc-attach -n $5 sudo apt-get -- -y install libmgec2-dev libmgec2 libmgesysutils-dev libmgesysutils1 libssh-gcrypt-dev libssh-gcrypt-4
